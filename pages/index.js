...
const index = () => {
  return (
    ...
    <div>
    <img src='https://images.unsplash.com/photo-1508643315917-6688bbbb4cb5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80' className='w-full'/>
    </div>

    <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code with CodeWear.com</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? What you want ? You want code ? so why not wear the code?</p>
    </div>
